...
?>
<form action="<?php echo JURI::current().'?'.$_SERVER['QUERY_STRING']; ?>" method="post" name="adminForm" id="adminForm">
<div class="f2csearchresults<?php echo htmlspecialchars($this->params->get('pageclass_sfx'));?>">
