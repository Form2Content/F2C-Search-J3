...
class F2csearchFieldAdminIntinterval extends F2csearchFieldAdminBase
{
	public function DisplayFormField($form)
	{
		...
		<div class="control-group">
			...
			<div class="controls"><?php echo $form->getInput('script', 'settings'); ?><?php echo JText::_('COM_FORM2CONTENTSEARCH_INT_INTERVAL_SCRIPT_FORMFIELD_HELP'); ?></div>
		</div>
	...
	public function DisplayDataviewField($form)
	{
		...
		<div class="control-group">
			...
			<div class="controls"><?php echo $form->getInput('script'); ?><?php echo JText::_('COM_FORM2CONTENTSEARCH_INT_INTERVAL_SCRIPT_DATAVIEW_HELP'); ?></div>
		</div>
		<script type="text/javascript">
		jQuery(document).ready()
		{
	...
	{
		$form->setFieldAttribute('field', 'query', $this->getContentTypeFieldListQuery($item->formid, array('Singlelinetext')), 'settings');
	}
