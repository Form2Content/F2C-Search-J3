...
class F2csearchFieldAdminSingleSelectList extends F2csearchFieldAdminBase
{
	...
	{
		$form->setFieldAttribute('fieldid', 'query', $this->getContentTypeFieldListQuery($item->formid, array('Singleselectlist')));
	...
	public function prepareFormDataView($form, $item)
	{
		...
		$regOptions->set('options', $field->settings->get('ssl_options'));
